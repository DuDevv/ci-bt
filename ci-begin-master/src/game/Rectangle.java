...
public class Rectangle {
    ...
    public boolean intersects(Rectangle other) {
        ...
        }else if (this.position.x+this.width < other.position.x   ||  this.position.y + this.height < other.position.y) {
            return false;
        }else if (this.position.x+this.width > other.position.x+other.width && this.position.y+this.height>other.position.y+other.height) {
            return false;
        }else {
            return true;
        }
